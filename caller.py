...
debug_edges = {'determine if battery is charging', 'calc battery demand'} if True else None

# Solve for a single node
t = mg.solve(demand_matrix, inputs, min_index=3, to_print=False, search_depth=1000, 
